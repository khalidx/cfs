...
Also, a native binary is available for [Windows](https://github.com/khalidx/cfs/releases/download/v0.10.0/cfs-win.exe), [Mac](https://github.com/khalidx/cfs/releases/download/v0.10.0/cfs-macos), and [Linux](https://github.com/khalidx/cfs/releases/download/v0.10.0/cfs-linux).
